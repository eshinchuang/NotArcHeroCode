		...
		*/
        ...
        private void Move_SuperUpdate()
        {
            ...
            if(rpgCharacterInputController.HasMoveInput() && canMove)
            {
                ...
                //Run.
                currentVelocity = Vector3.MoveTowards(currentVelocity, rpgCharacterInputController.moveInput * runSpeed * speedcontroll.value, movementAcceleration * superCharacterController.deltaTime);
            }
            else
            {
                currentState = RPGCharacterState.Idle;
